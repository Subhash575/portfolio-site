  ...
  if (variant === 'code') {
    return (
      <motion.div
        ...
        className={`w-64 sm:w-72 p-5 sm:p-6 rounded-3xl glass-gradient backdrop-blur-2xl border border-white/40 dark:border-white/10 shadow-2xl ${className}`}
      >
        ...
        <div className="space-y-2.5 font-mono text-[11px] text-left">
          ...
          <div className="pl-4 text-on-surface-variant">
            focus: <span className="text-primary">&quot;Full Stack&quot;</span>,
          </div>
          <div className="pl-4 text-on-surface-variant">
